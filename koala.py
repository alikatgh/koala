...
# Load images
koala = pygame.transform.scale(pygame.image.load(
    "/Users/work/Documents/python/Koala Game/koala.png"), (40, 40))
strawberry = pygame.transform.scale(
    pygame.image.load("/Users/work/Documents/python/Koala Game/strawberry.png"), (40, 40))
squirrel = pygame.transform.scale(pygame.image.load(
    "/Users/work/Documents/python/Koala Game/squirrel.png"), (40, 40))
...
while True:
    ...
    if game_state == PLAYING:
        ...
        # Draw "openai" text
        openai_text = font.render("demo", True, TEXT_COLOR)
